# Version 2.0.3 release: 8/29/2024 | Last edit: 10/21/24
# Built by cdUAH
# Cleaned 3/20/25
...
def xrefcsv():
    ...
    def to_epoch(s):
        ...
        try:
            ...
            error_counter += 1
            print("Epoch Conversion Error. Probable un-decoded file. This could be a retransmit over alternative port")
        ...
        while True:
            ...
            match choice:
                ...
                case '4':
                    ...
                    print("$ This feature isn't supported, running Pre/Post instead")
                    choice = '1'
                    return choice
                case '0':
                    print("$ Exiting!")
    ...
    if donext == '1' or donext == '2':
        ...
        print(f"Error! Choice was {donext}, NOT SURE WHY THIS CHOICE WAS CHOSEN")
    ...
    df1_filtered.to_csv(path + "filtered_" + outfile1)
    df2_filtered = df2[(df2['Embedded Time (Epoch)'] >= overlap_min)
                       & (df2['Embedded Time (Epoch)'] <= overlap_max)]
    df2_filtered.to_csv(path + "filtered_" + outfile2) #creates filtered file
